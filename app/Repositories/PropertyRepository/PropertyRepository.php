...
class PropertyRepository extends BaseRepository implements PropertyRepositoryInterface
{
    ...
    public function find($id)
    {
        ...
        // Sử dụng raw SQL query với string concatenation - KHÔNG AN TOÀN
        try {
            ...
            // Re-throw ModelNotFoundException
            throw $e;
        } catch (\Exception $e) {
            ...
            // Throw lại exception để controller có thể bắt và hiển thị lỗi SQL
            throw $e;
        }
